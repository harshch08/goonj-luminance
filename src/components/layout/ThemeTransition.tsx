...
export const ThemeTransition = () => {
  ...
  useEffect(() => {
    ...
    const isBandhanTheme = bandhanPages.some(p => location.pathname === p || location.pathname.startsWith('/bandhan/'));
    const wasBandhanTheme = bandhanPages.some(p => prevPathRef.current === p || prevPathRef.current.startsWith('/bandhan/'));
